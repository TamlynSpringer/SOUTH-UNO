    ...
    <section className='about-section'>
      <article>
        ...
        <p> 
          ...
          <a href='https://github.com/apardor' target='_blank' rel='noreferrer'><i className='fa-brands fa-square-github'></i></a>
          Andrés Pardo Rodriguez
        </p>
        <p>
          <a href='/'><i className='fa-brands fa-linkedin'></i></a>
          <a href='https://github.com/HandyAndyOG' target='_blank' rel='noreferrer'><i className='fa-brands fa-square-github'></i></a>
        Andreas Cross
        </p>
        <p>
          <a href='/'><i className='fa-brands fa-linkedin'></i></a>
          <a href='https://github.com/PriscillaReboucas' target='_blank' rel='noreferrer'><i className='fa-brands fa-square-github'></i></a>
        Priscilla Barbosa Rebouças
        </p>
        <p>
          <a href='/'><i className='fa-brands fa-linkedin'></i></a>
          <a href='https://github.com/TamlynSpringer' target='_blank' rel='noreferrer'><i className='fa-brands fa-square-github'></i></a>
          Tamlyn Springer
        </p>
        <h3>As our final project in the School of Applied Technology's JavaScript career program.</h3>
